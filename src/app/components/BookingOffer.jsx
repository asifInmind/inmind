    ...
    <>
      <section className="overflow-hidden w-full h-auto md:h-181.25 flex justify-center items-center flex-col bg-[#000000] py-16 md:py-0 px-4 relative">
        ...
        <motion.p
          ...
          className="w-full max-w-310.5 h-auto text-center text-[#fcfcfc] font-medium text-[15px] md:text-[18px] leading-[100%] mb-10 md:mb-17 mt-4 md:mt-17"
        >
        ...
        <motion.div
          className="absolute right-70 left-70 -bottom-90 opacity-30"
