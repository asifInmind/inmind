  ...
  return (
    <>
      <section className="overflow-hidden w-full   h-auto md:h-181.25 flex justify-center items-center flex-col bg-[#000000] py-16 md:py-0 px-4 relative">
        ...
        <div className="border md:px-3.5 w-full ">
          <motion.h1
            initial="hidden"
            whileInView="visible"
            viewport={{ once: false }}
          ...
          <motion.div
            ...
            className="w-full max-w-197.5 h-auto flex flex-col md:flex-row justify-center items-center gap-4 md:gap-5 mx-auto text-[#fcfcfc] pt-10 md:pt-10"
          >
            <motion.p
              variants={badgeItem}
