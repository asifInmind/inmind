...
`,
  ...
  return (
    <>
      <section className="bg-[#FAF9F6] h-195 relative">
        <div className="w-257.5 h-47 py-16  ">
          <div className="ms-25 mt-25">
        ...
        <div className="absolute right-1">
          <div className=" relative  ">
            <Image src="/icons/Ellipse 2357.svg" width={30} height={30} className="absolute left-14 top-[-100]" />
            <Image src="/icons/Ellipse 2357.svg" width={30} height={30} className="absolute right-3.5 -bottom-1"  />
            <Image src={"/icons/Vector 19.svg"} width={200} height={200} />
          </div>
        </div>
      </section>
    </>
